...
export const Crumb = ({ label }: CrumbProps) => {
  return (
    <Link to={getPath(label)} className="flex items-center gap-1 text-lg group">
      ...
      <span className="group-last:underline group-last:text-primary group-last:font-medium px-2 rounded-md group-hover:text-primary group-hover:underline underline-offset-4 cursor-pointer">
        {label}
      </span>
