...
const SocialProof = () => {
  return (
    <section className="relative py-16 md:py-20 border-y border-white/10 bg-theme_primary_black">
        ...
        <div className="mt-8 md:mt-10 grid grid-cols-2 md:grid-cols-4 gap-y-8 md:gap-y-0">
          {stats.map((item, i) => (
            ...
            >
              ...
              <div className="text-[10.5px] text-secondary_text uppercase tracking-[0.18em]">
                {item.label}
              </div>
              {i < stats.length - 1 && (
