...
const Hero = () => {
  return (
    <>
      <h1 className="text-[2.5rem] md:text-[3.5rem] xl:text-[5rem] leading-[2.5rem] md:leading-[3.5rem] xl:leading-[5rem]  text-center xl:max-w-[50vw] font-semibold text-primary_text">
        Centralized Bookmark Manager for Modern Life
      </h1>
      <p className="text-2xl font-light text-secondary_text text-center max-w-[50vw]">
      ...
      <GlowCard
        className="w-60 h-14 rounded-full before:w-60 before:h-20 border-[2px] border-white/20 text-white mt-8 cursor-pointer"
